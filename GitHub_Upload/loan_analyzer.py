...
print(f"There are {number_of_loans} loans from the list.")
...
print(f"The remaining months of the loans is {remaining_months} months")
...
if present_value >= loan_price:
    print(f"The loan is worth ${round(present_value,2)}, which is more than it's cost at ${loan_price}. So buy it!")
else:
...
print(f"Inexpensive loans are: {inexpensive_loans}")
...
print("Please check the CSV file for results.")
